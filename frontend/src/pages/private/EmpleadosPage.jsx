        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Fecha Ingreso</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Salario</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-100">
            {loading ? (
              <tr>
                <td colSpan="4" className="text-center p-6">Cargando...</td>
              </tr>
            ) : empleados.length === 0 ? (
              <tr>
                <td colSpan="4" className="text-center p-6 text-gray-500">Sin resultados</td>
              </tr>
            ) : (
              empleados.map((emp) => (
                <tr key={emp.id}>
                  ...
                  <td className="px-6 py-4">${Number(emp.salario).toLocaleString()}</td>
                </tr>
              ))
            )}
          </tbody>
